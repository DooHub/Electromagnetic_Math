...
+ ### 상기 방식으로는 접근이 어려움. 삼각함수를 고려하여 계산, 항의 제곱 형태
  ...
  ### [적분 공식 $\int_{}^{}\text{sec}\theta d\theta=\text{ln}\left| \text{tan}\theta+\text{sec}\theta \right|+C$](https://github.com/DooHub/Electromagnetic_Math/blob/main/Chapt15%EC%A0%81%EB%B6%84%EA%B3%B5%EC%8B%9D.md#13-int_textsecxdxlnleft-textsecxtexttanx-rightc)
