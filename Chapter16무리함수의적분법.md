...
### $\frac{1}{\rho^2}\int_{-\frac{\pi}{2}}^{\frac{\pi}{2}}\text{cos}\theta d\theta=\frac{2}{\rho^2}\int_{0}^{\frac{\pi}{2}}\text{cos}\theta d\theta=\frac{2}{\rho^2}\\;\text{sin}\theta |_{0}^{\frac{\pi}{2}}=\frac{2}{\rho^2}$
